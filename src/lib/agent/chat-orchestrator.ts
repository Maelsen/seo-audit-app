...
function buildSystemPrompt(context: ChatContext): string {
  ...
  parts.push(
    ...
    "",
    "   Pages bestehen ausschliesslich aus dekomponierten Bloecken (text/image/shape/scoreCircle/checkList/table/topRiskList/recommendationList/barChart/gauge/starRating/resourceTile/serpPreview/brandDecoration/arrowBulletList/comparisonTable/pieChart/findingsTable).",
